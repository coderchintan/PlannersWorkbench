 ...
 * snrecurring.java
 *
 * Created on Jul 17, 2016, 10:35:53 AM
 */
 ...
 * @author Ankush
 */
public class snrecurring extends javax.swing.JInternalFrame {
...
jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Instrument Name");
...
private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
    ...
    connector c=new connector();
    PreparedStatement ps=c.con.prepareStatement("select * from nrecurring1 where insname='"+search+"'");
    ResultSet rs=ps.executeQuery();
    jTable1.setModel(DbUtils.resultSetToTableModel(rs));
...
connector c=new connector();
PreparedStatement ps=c.con.prepareStatement("select * from nrecurring1 where id='"+table_click+"'");
ResultSet rs=ps.executeQuery();
while(rs.next()){
...
String insname=jTextField3.getText();
String model=jTextField4.getText();
String project=jTextField5.getText();
//date of purchase
...
connector c=new connector();
PreparedStatement ps1=c.con.prepareStatement("select * from nrecurring1 where id='"+chemid+"'");
...
int bal=q-qq;
PreparedStatement ps2=c.con.prepareStatement("update nrecurring1 set quant='"+bal+"' where id='"+chemid+"'");
ps2.executeUpdate();
}
}
PreparedStatement ps=c.con.prepareStatement("insert into issuenr values(?,?,?,?,?,?,?)");
